...
moduleFactura.controller('facturaPlistController', ['$scope', '$http', '$location', 'toolService', '$routeParams', 'sessionService','pdfService',
    function ($scope, $http, $location, toolService, $routeParams, sessionService,pdfService) {
